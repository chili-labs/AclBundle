...
class AppTestDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/Tests/App/cache/test/annotations', true);
    }
    ...
    {
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer(new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($this->get('kernel'), $this->get('templating.filename_parser'), '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/Tests/App/Resources'), $this->get('templating.locator')), 1 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router'))));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventSubscriber($this->get('projecta_acl.doctrine_subscriber'));
        $c->addEventListener(array(0 => 'postGenerateSchema'), 'security.acl.dbal.schema_listener');

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('memory' => true, 'driver' => 'pdo_sqlite', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => array()), $b, $c, array());
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/Tests/App/Resources');
    }
    ...
    /**
     * Gets the 'projecta_acl.doctrine_subscriber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return ProjectA\Bundle\AclBundle\EventListener\DoctrineSubscriber A ProjectA\Bundle\AclBundle\EventListener\DoctrineSubscriber instance.
     */
    protected function getProjectaAcl_DoctrineSubscriberService()
    {
        return $this->services['projecta_acl.doctrine_subscriber'] = new \ProjectA\Bundle\AclBundle\EventListener\DoctrineSubscriber($this);
    }
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/Tests/App/config/routing.yml', array('cache_dir' => '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/Tests/App/cache/test', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'AppTestUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'AppTestUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), NULL);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/Tests/App/cache/test/secure_random.seed', NULL);
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/Tests/App/cache/test/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/Tests/App/cache/test/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/Tests/App', 'UTF-8');
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/Tests/App/cache/test/translations', 'debug' => true));

        $instance->setFallbackLocales(array(0 => 'en'));
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ar.xlf', 'ar', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ca.xlf', 'ca', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.cs.xlf', 'cs', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.da.xlf', 'da', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.de.xlf', 'de', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.el.xlf', 'el', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.en.xlf', 'en', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.es.xlf', 'es', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.fa.xlf', 'fa', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.fr.xlf', 'fr', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.gl.xlf', 'gl', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.hu.xlf', 'hu', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.it.xlf', 'it', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.lb.xlf', 'lb', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.nl.xlf', 'nl', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.no.xlf', 'no', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pl.xlf', 'pl', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pt_BR.xlf', 'pt_BR', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pt_PT.xlf', 'pt_PT', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ro.xlf', 'ro', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ru.xlf', 'ru', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sk.xlf', 'sk', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sl.xlf', 'sl', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sr_Cyrl.xlf', 'sr_Cyrl', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sr_Latn.xlf', 'sr_Latn', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sv.xlf', 'sv', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.tr.xlf', 'tr', 'security');
        $instance->addResource('xlf', '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/vendor/symfony/security/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ua.xlf', 'ua', 'security');
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/Tests/App/cache/test');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/Tests/App',
            'kernel.environment' => 'test',
            'kernel.debug' => true,
            'kernel.name' => 'App',
            'kernel.cache_dir' => '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/Tests/App/cache/test',
            'kernel.logs_dir' => '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/Tests/App/logs',
            'kernel.bundles' => array(
                'FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle',
                'SecurityBundle' => 'Symfony\\Bundle\\SecurityBundle\\SecurityBundle',
                'DoctrineBundle' => 'Doctrine\\Bundle\\DoctrineBundle\\DoctrineBundle',
                'ProjectAAclBundle' => 'ProjectA\\Bundle\\AclBundle\\ProjectAAclBundle',
            ),
            ...
            'debug.container.dump' => '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/Tests/App/cache/test/AppTestDebugProjectContainer.xml',
            ...
            'session.save_path' => '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/Tests/App/cache/test/sessions',
            ...
            'router.resource' => '/Users/danieltschinder/Documents/PA/SkyPrism/vendor/project-a/acl-bundle/ProjectA/Bundle/AclBundle/Tests/App/config/routing.yml',
