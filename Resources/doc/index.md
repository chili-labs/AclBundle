...
2. [Working with the ACL Manager](working_with_the_acl_manager.md)
    1. [Retrieving the ACL und ACE Managers](working_with_the_acl_manager.md#retrieving-the-acl-und-ace-managers)
    2. [Granting](working_with_the_acl_manager.md#granting)
    3. [Revoking](working_with_the_acl_manager.md#revoking)
    4. [Deleting ACLs](working_with_the_acl_manager.md#deleting-acls)
    5. [Preloading](working_with_the_acl_manager.md#preloading)
